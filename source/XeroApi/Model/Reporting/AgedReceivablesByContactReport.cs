...
{
    public class AgedReceivablesByContactReport : DynamicReportBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgedReceivablesByContactReport"/> class.
        /// </summary>
        ...
        public AgedReceivablesByContactReport(Guid contactId, DateTime? date = null, DateTime? fromDate = null, DateTime? toDate = null)
        {
