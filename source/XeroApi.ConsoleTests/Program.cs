...
namespace XeroApi.ConsoleApp
{
	class Program
	{
		...
		static void ExerciseOrganisation( Repository repository )
		{
			...
			TestAlteringAwaitingApprovalInvoice( repository );
			TestAlteringApprovedInvoiceWithNoPaymentsOrAllocations( repository );
			TestAlteringTrackingAndAccountForApprovedInvoiceWithPayments( repository );
			...
			TestCreatingInvoiceAsSubmittedForApproval( repository );
